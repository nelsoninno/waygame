...
{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.onCreatedContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.onCreatedContext.GDObjectObjects1[i]._setPreviousInitialValue(eventsFunctionContext.getObjects("Object")[0]._getInitialValue());
}
}}
...
for (var i = 0, k = 0, l = gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.onHotReloadingContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.onHotReloadingContext.GDObjectObjects1[i]._getInitialValue() != eventsFunctionContext.getObjects("Object")[0]._getPreviousInitialValue() ) {
        isConditionTrue_0 = true;
...
{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.onHotReloadingContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.onHotReloadingContext.GDObjectObjects1[i]._setPreviousInitialValue(eventsFunctionContext.getObjects("Object")[0]._getInitialValue());
}
}{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.onHotReloadingContext.GDObjectObjects1.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.doStepPostEventsContext.GDBackgroundObjects1.length ;i < len;++i) {
    ...
    gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.doStepPostEventsContext.GDBackgroundObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Resizable")).setWidth((gdjs.RuntimeObject.getVariableNumber(gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.doStepPostEventsContext.GDBackgroundObjects1[i].getVariables().get("Width"))));
}
}{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.doStepPostEventsContext.GDBackgroundObjects1.length ;i < len;++i) {
    gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.doStepPostEventsContext.GDBackgroundObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Resizable")).setHeight((gdjs.RuntimeObject.getVariableNumber(gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.doStepPostEventsContext.GDBackgroundObjects1[i].getVariables().get("Height"))));
}
}{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.doStepPostEventsContext.GDObjectObjects1.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.SetValueContext.GDFillBarObjects1.length ;i < len;++i) {
    ...
    gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.SetValueContext.GDFillBarObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Resizable")).setWidth(eventsFunctionContext.getArgument("Value") * (( gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.SetValueContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__TiledUnitsBar__TiledUnitsBar.TiledUnitsBar.prototype.SetValueContext.GDObjectObjects1[0]._getUnitWidth()));
}
}}
